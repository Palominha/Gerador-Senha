...
const letraMinus = document.querySelector("#letraMinusid");
const letraMaius = document.querySelector("#letraMaiusid");
const numerosId = document.querySelector("#numerosId");
const simbolosiD = document.querySelector("#simbolosId");
